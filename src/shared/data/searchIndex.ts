...
export const documentationIndex: SearchIndexEntry[] = [
  ...
  // Mantran.Applications - API — Dafiti
  {
    path: paths.mantranApi.dafiti,
    hash: "mantran_api_dafiti",
    page: "Mantran.Applications - API",
    label: "Dafiti — Visão Geral",
    content: "dafiti integracao pedido remessa disparo receber-pedido POST controller marketplace api/Dafiti",
  },
  {
    path: paths.mantranApi.dafiti,
    hash: "dafiti_como_funciona",
    page: "Mantran.Applications - API",
    label: "Dafiti — Como Funciona",
    content: "formato do parceiro resposta json malformado desserializacao manual 401 403 padrao",
  },
  {
    path: paths.mantranApi.dafiti,
    hash: "dafiti_modelo_requisicao",
    page: "Mantran.Applications - API",
    label: "Dafiti — Modelo de Dados da Requisição",
    content:
      "DISPARO REMETENTE TRANSPORTADORA ENTREGA CARGA DATA HORA RAZAO_SOCIAL CNPJ QUANTIDADE_REMESSAS upper snake case",
  },
  {
    path: paths.mantranApi.dafiti,
    hash: "dafiti_modelo_entrega",
    page: "Mantran.Applications - API",
    label: "Dafiti — Modelo de Dados da Entrega",
    content:
      "ENTREGA PEDIDO REMESSA LOJA DESTINATARIO MERCADORIAS VOLUMES_NF ORIGEM_MARKET_PLACE DADOS_DANFE CHAVE_DANFE CFOP_NF ALIQUOTA_ICMS BASE_CALCULO_ICMS AWB peso cubagem",
  },
  {
    path: paths.mantranApi.dafiti,
    hash: "dafiti_modelo_resposta",
    page: "Mantran.Applications - API",
    label: "Dafiti — Modelo de Dados da Resposta",
    content:
      "RESPOSTA CARGA RETORNO PROTOCOLO REMESSA CODIGO MENSAGEM 700 701 705 999 sucesso erro remessa validacao interno",
  },
  {
    path: paths.mantranApi.dafiti,
    hash: "dafiti_validacoes",
    page: "Mantran.Applications - API",
    label: "Dafiti — Validações do Payload",
    content: "validacao 705 obrigatorio DISPARO REMETENTE TRANSPORTADORA ENTREGA DESTINATARIO primeira falha",
  },
  {
    path: paths.mantranApi.dafiti,
    hash: "dafiti_comportamentos",
    page: "Mantran.Applications - API",
    label: "Dafiti — Comportamentos Especiais",
    content:
      "milk run TIPO_ESTOQUE fulfillment autocadastro cliente hub desenvolvedor remessa duplicada protocolo TRANSPABC nota fiscal ignorada sem danfe",
  },
  {
    path: paths.mantranApi.dafiti,
    hash: "dafiti_endpoint_receber_pedido",
    page: "Mantran.Applications - API",
    label: "Dafiti — Receber Pedido",
    content: "receber-pedido POST requisicao resposta erro 400 401 403 500 codigo 705 999",
  },
  ...
  // Mantran.Applications - API — Gerar Token
  {
    ...
    content:
      "gerar token acesso endpoint autenticacao usuario senha POST bearer authorization como usar API token expirar 1 hora Postman Insomnia curl",
  },
  {
    path: paths.mantranApi.gerarToken,
    ...
    content: "endpoint URL producao POST token api/auth/token Content-Type application json",
  },
  {
    path: paths.mantranApi.gerarToken,
  ...
  // Segurança (grupo "Seguradora" no menu — Corretora e Seguradora são sinônimos no sistema — dentro de Mantran.Applications - API)
  {
