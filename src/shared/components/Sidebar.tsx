...
const navItems: NavSection[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        key: "integracoes",
        label: "Integrações",
        items: [leaf(paths.mantranApi.rotaLivre, "Rota Livre"), leaf(paths.mantranApi.dafiti, "Dafiti")],
      },
      leaf(paths.mantranApi.corretora, "Seguradora"),
      leaf(paths.mantranApi.arquitetura, "Arquitetura", { private: true }),
      leaf(paths.mantranApi.login, "Login (Autenticação e Autorização)", { private: true }),
