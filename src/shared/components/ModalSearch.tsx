...
function ModalSearch({ isOpen, onClose, searchText, results, onNavigate, onSearchChange }: ModalSearchProps) {
          ...
          {results.length === 0 ? (
            ...
            results.map((res) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500 line-clamp-2">{res.preview}</p>
              </div>
            ))
          )}
        </div>
