    ...
    <div className="conteudo-div">
      ...
      <section id="mantran_api_gerar_token">
        ...
        <p>
          ...
          O endpoint <code>token</code> é destinado ao uso por <strong>integrações externas e
          sistemas de terceiros.</strong>
        </p>
        <p>
...

{
  ...
  "accessToken": "eyJhbGciOiJFQ0RILUVTK0EyNTZLVyIsImVuYyI6IkEyNTZHQ00i...",
        ...
        <table className="data-table">
          ...
          <tbody>
            <tr>
              ...
              <td>string</td>
              <td>Token de acesso — use no header <code>Authorization: Bearer</code></td>
            </tr>
            <tr>
...
Content-Type: application/json
Authorization: Bearer eyJhbGciOiJFQ0RILUVTK0EyNTZLVyIsImVuYyI6IkEyNTZHQ00i...
  ...
  // corpo da sua requisição
      ...
      <section id="gerar_token_renovacao">
        ...
        <p>
          ...
          operando, basta repetir a chamada ao endpoint de geração de token com as suas credenciais.
        </p>
