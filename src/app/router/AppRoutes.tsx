...
import MantranApiSeguradoraClientePage from "@pages/mantranApi/seguradora/MantranApiSeguradoraClientePage";
import MantranApiSeguradoraGrupoPage from "@pages/mantranApi/seguradora/MantranApiSeguradoraGrupoPage";
import MantranApiSeguradoraPercursoPage from "@pages/mantranApi/seguradora/MantranApiSeguradoraPercursoPage";
import MantranApiSeguradoraProdutoPage from "@pages/mantranApi/seguradora/MantranApiSeguradoraProdutoPage";
import MantranApiSeguradoraUrbanoPage from "@pages/mantranApi/seguradora/MantranApiSeguradoraUrbanoPage";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path={paths.mantranApi.seguradoraCliente} element={<MantranApiSeguradoraClientePage />} />
      <Route path={paths.mantranApi.seguradoraGrupo} element={<MantranApiSeguradoraGrupoPage />} />
      <Route path={paths.mantranApi.seguradoraPercurso} element={<MantranApiSeguradoraPercursoPage />} />
      <Route path={paths.mantranApi.seguradoraProduto} element={<MantranApiSeguradoraProdutoPage />} />
      <Route path={paths.mantranApi.seguradoraUrbano} element={<MantranApiSeguradoraUrbanoPage />} />
